...
void logIMUData(void)
{
  ...
  //  {'S', 'T', Roll_H, Roll_L, Pitch_H, Pitch_L, Yaw_H, Yaw_L, difference, time_interval, 'E'}
  //Generate package
...
//      LOG_PORT.print(String(IMU.rpy_[0])+ "R  " );
//      LOG_PORT.print(String(IMU.rpy_[1])+ "P  " );
//      LOG_PORT.println(String(IMU.rpy_[2])+ "Y  " );
